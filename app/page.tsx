...
export default function Home() {
  ...
  return (
    <main className="container">
      <div className="relative flex p-5 border-[1px] border-gray-300 rounded-md mt-5">
        ...
        <div className="relative flex-grow max-w-[665px] min-h-full px-[45px] py-[56px] mr-4">
